...
<head>
    ...
    <title>Archidiocesan Shrine of Apostol de Compostela - Admin Registration</title>
    <style>
        .container {
            padding: 20px;
            border-radius: 10px;
    ...
    <div class="container mt-5" id="content-main">
        <div class="row justify-content-center">
            <div class="col-lg-6 text-center">
                <h1 class="display-4">Invalid Verification Code</h1>
                <h3>
                    Invalid verification code. Please try again or contact the administrator.
                </h3>
